...
namespace HiveMind.Events
{
    ...
    public class MushroomScriptableObj : ScriptableObject
    {
        ...
        public UnityEvent updateSettingsEvent;
        #endregion
        #endregion
        ...
        private void OnEnable()
        {
            ...
            {
                updateSettingsEvent = new UnityEvent();
            }
            #endregion
        }
        ...
        /// <summary>
        /// Set whether the Player is touching the quick bounce message trigger or not
        /// </summary>
        /// <param name="showingQuickBounce">Whether the Player is touching the quick bounce message trigger or not</param>
        ...
        /// <summary>
        /// Set whether the quick bounce tutorial message should be shown or not
        /// </summary>
        /// <param name="showingQuickBounce">Whether the quick bounce tutorial message should be shown or not</param>
