...
namespace GoodLuckValley.UI.Menus.Main.States
{
    public class AudioMenuState : MainMenuState
    {
        ...
        public AudioMenuState(MainMenuController controller, CanvasGroup screen, Image darkerBackground, IOptionMenu optionMenu, IMenuController menuController, float fadeDuration) 
