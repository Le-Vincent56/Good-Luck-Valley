...
namespace GoodLuckValley.UI.Menus.Main.States
{
    public class VideoMenuState : MainMenuState
    {
        ...
        public VideoMenuState(MainMenuController controller, CanvasGroup screen, Image darkerBackground, IOptionMenu optionMenu, IMenuController menuController, float fadeDuration) 
