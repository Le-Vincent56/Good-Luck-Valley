...
namespace GoodLuckValley.UI.Menus.Main.States
{
    public class SettingsMenuState : MainMenuState
    {
        ...
        public SettingsMenuState(MainMenuController controller, CanvasGroup screen, Image darkerBackground, IOptionMenu optionMenu, IMenuController menuController, float fadeDuration) 
