...
{
    public class ControlsMenuState : SettingsState
    {
        public ControlsMenuState(GameSettingsMenu menu, StateMachine stateMachine, bool fadeInOut, Exclusions exclusions, GameObject uiObject, MenuCursor cursor)
