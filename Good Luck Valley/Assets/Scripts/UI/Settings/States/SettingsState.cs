...
namespace GoodLuckValley.UI.Settings.States
{
    public class SettingsState : IState
    {
        ...
        protected GameSettingsMenu menu;
        ...
        public SettingsState(GameSettingsMenu menu, StateMachine stateMachine, bool fadeInOut, Exclusions exclusions, GameObject uiObject, MenuCursor cursor)
        {
            this.menu = menu;
