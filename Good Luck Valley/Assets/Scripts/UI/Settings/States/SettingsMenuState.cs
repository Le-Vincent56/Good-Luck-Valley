...
{
    public class SettingsMenuState : SettingsState
    {
        public SettingsMenuState(GameSettingsMenu menu, StateMachine stateMachine, bool fadeInOut, Exclusions exclusions, GameObject uiObject, MenuCursor cursor)
