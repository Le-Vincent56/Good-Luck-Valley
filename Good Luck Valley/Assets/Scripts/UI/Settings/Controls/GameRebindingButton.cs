...
namespace GoodLuckValley.UI.Settings.Controls
{
    ...
    public class GameRebindingButton : MonoBehaviour
    {
        ...
        public void Init(GameControlsSettingController controller, InputActionAsset inputActionAsset, InputKeyDictionary keysDictionary)
        {
            // Get component
