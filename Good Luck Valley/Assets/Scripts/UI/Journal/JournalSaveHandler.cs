...
{
    public class JournalSaveHandler : MonoBehaviour, IBind<Persistence.JournalData>
    {
        private JournalSystem system;
        private bool unlocked;
        private List<int> entriesUnlocked;

        [SerializeField] private Persistence.JournalData journalData;
        ...
        /// </summary>
        public void Bind(Persistence.JournalData journalData)
        {
            // Bind data
